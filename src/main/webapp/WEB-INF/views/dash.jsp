...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="resources/imgage/apple-icon.png">
  <link rel="icon" type="image/png" href="resources/imgages/favicon.png">
...
<body class="">
 ...
 <!--  <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script> -->
  ...
  <script src="resources/js/material-dashboard.min.js?v=2.1.0" type="text/javascript"></script>
</body>
